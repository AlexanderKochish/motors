...
import ControlPanel from "@/components/admin/control-panel/control-panel";
import GalleryList from "../gallery-list/gallery-list";
import Loading from "@/components/ui/loading/loading";
import { AdminActions } from "@/components/admin/admin-service-actions/admin-service-action";
import { removeById } from "@/app/actions/gallery";
